...
const List<_WarmMessage> _warmMessages = [
  _WarmMessage(
    ...
    science:
        '双相情感障碍是一种以情绪极端波动为特征的精神疾病，患者在躁狂期精力旺盛、思维奔涌，在抑郁期则情绪低落、精力匮乏，两种状态交替或混合出现。',
  ...
  _WarmMessage(
    ...
    science:
        '抑郁症并非简单的"心情不好"，而是大脑神经递质失衡导致的持续情绪低落，核心症状包括兴趣丧失、精力减退和自我评价降低，严重时可出现自杀念头。',
  ...
  _WarmMessage(
    ...
    science:
        '焦虑症是大脑杏仁核过度激活的结果，它把"万一"当成"一定"，让身体持续处于"战斗或逃跑"的警报状态，表现为心跳加速、呼吸急促和无法控制的担忧。',
  ...
  _WarmMessage(
    ...
    science:
        '强迫症的特征是反复出现的侵入性念头（强迫思维）和不得不执行的重复行为（强迫行为），大脑试图通过仪式化的重复来获得安全感，但效果短暂且形成恶性循环。',
  ...
  _WarmMessage(
    ...
    science:
        'PTSD 是大脑对创伤事件的"过度保护"反应，杏仁核持续警觉，导致闪回、噩梦和回避行为——大脑记住了危险，却在安全的环境中也无法放松。',
  ...
  _WarmMessage(
    ...
    science:
        'ADHD 是神经发育的差异而非态度问题，核心表现为注意力易分散、冲动和多动，但也伴随超专注能力和发散性思维——大脑只是用不同的方式处理信息。',
  ...
  _WarmMessage(
    ...
    science:
        '精神分裂症是一种严重的精神障碍，主要表现为幻觉（如听到不存在的声音）、妄想（坚信不真实的想法）和思维紊乱，并非"人格分裂"，而是大脑感知与认知功能的失调。',
  ...
  _WarmMessage(
    ...
    science:
        '解离性人格障碍（曾称多重人格障碍）是极端创伤后形成的心理防御机制，患者在不同人格状态间转换，每个部分承载着不同的记忆和情感，目的是保护核心自我免受进一步伤害。',
  ...
  _WarmMessage(
    ...
    science:
        '社交恐惧症不只是"害羞"，而是对社交场景产生强烈的恐惧和回避，大脑将人际互动误判为威胁，导致心跳加速、出汗颤抖，甚至完全回避一切社交。',
  ...
  _WarmMessage(
    ...
    science:
        '进食障碍（如厌食症、暴食症）是以异常饮食行为为特征的精神疾病，核心是对体重和体型的过度关注与控制，往往掩盖了更深层的情绪需求和自我认同困境。',
